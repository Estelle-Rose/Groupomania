<template>
  <v-container fluid class="feed-container">  
       ...
       <v-row class="bloc">
          <v-col sm="12" md="6" class="mx-auto">   
            <v-card flat class="posts-card ">                  
                ...
                <v-card-title class=" d-flex justify-space-between" fixed flat dense dark>
                    <v-tooltip bottom>
       ...
       <v-row class=" bloc2 text-center d-flex flex-column justify-center align-center"> 
        <v-col sm="12" md="6" class="mx-auto">
          <v-card
        ...
        <v-card v-if="$store.state.posts.length === 0" class="posts-card mx-auto" elevation="0">
